package com.example.Clinic.security.support;

/** Provides encoding of raw bytes to base64-encoded characters, and
 *  decoding of base64 characters to raw bytes.<p>
 *
 *  Slightly modified by Branko Milosavljevic (mbranko@uns.ns.ac.yu).
 *
...
public class Base64 {
  ...
  /** Returns a <code>String</code> of base64-encoded characters to represent
   *  the passed data array.
   *
   *  @param data the array of bytes to encode
   *  @return base64-coded character <code>String</code>.
   */
   ...
   *  <code>String</code>.
   *
   *  @param data <code>String</code> of base64-encoded characters
   *  @return decoded data array
   */
